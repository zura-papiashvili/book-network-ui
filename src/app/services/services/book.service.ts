...
export class BookService extends BaseService {
  ...
  static readonly ReturnBookPath = '/books/return/{book-id}';
   ...
   */
  uploadBookCover$Response(
    params: UploadBookCover$Params,
    context?: HttpContext
  ...
  static readonly ApproveReturnPath = '/books/approve-return/{book-id}';
   ...
   * This method doesn't expect any request body.
   */
  approveReturn$Response(
    params: ApproveReturn$Params,
    context?: HttpContext
  ): Observable<StrictHttpResponse<number>> {
